...
class RecipeView {
  ...
  #data;
  render(data) {
    this.#data = data; // hcontains the receipt object
    console.log(this.#data);
    const markup = this.#generateMarkup();

    // remove footer message<p>Start by searching for a recipe or an ingredient. Have fun!</p>
    this.#clear;
    this.#parentElement.insertAdjacentHTML('afterbegin', markup); //render the recipe
  }
...
`;
  ...
  #generateMarkupIngredient(ing) {
    ...
    //"new Fraction" will convert decimal numbers into a fraction by importing
    //fractional npm packages
    return `
